import { Component, Input, Output, ViewChild, EventEmitter, NgZone, forwardRef, AfterViewInit, ElementRef, OnDestroy } from '@angular/core';
    ...
    ngAfterViewInit() {
        ...
        if (this.instance) {
            ...
            this.instance.ui.addButton('imageUploader', {
                label: 'Загрузить изображение на сервер',
